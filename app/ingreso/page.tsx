...
export default function Page(this: any, {
    ...
    if (error) return <>
        ...
        {loading ? <Loading message={"Verificando usuario..."} /> :
                <form onSubmit={check} method='POST' className="bg-white/50 shadow-xl shadow-black/50 m-auto py-2 w-3/4 xl:w-2/4 rounded-md">
                    <div className="pt-12. text-center content-center">
                        <h1 className="text-black text-3xl font-bold leading-7 text-neutral-950">Iniciar sesion</h1>
                        <div className="mt-10 grid grid-cols-1 gap-x-10 gap-y-8 sm:grid-cols-1 w-3/5 m-auto content-center">
                            ...
                            <div className="sm:col-span-1 sm:col-start-2.">
                                <label htmlFor="city" className="block text-sm font-medium leading-6 text-neutral-950">
                                    Nombre de usuario
                                </label>
                                <div className="mt-2">
                                    <input
                                        ...
                                        className="text-center block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-2 ring-inset ring-neutral-950 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                                    />
                                </div>
                            </div>
