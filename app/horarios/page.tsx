...
export default async function Page({
    ...
    return <div className="text-center h-screen flex flex-col justify-center xl:mt-5">
        <NavBar></NavBar>
        <div>
        ...
        <div className="mt-4">
            <h1 className="text-3xl font-bold text-gray-900">Horarios de la fecha {`${f.getUTCDate()}/${f.getUTCMonth()+1}/${f.getUTCFullYear()}`}</h1>
