export default function Page() {
    return <div>
        <div>
            <form action="" method="post" className="m-auto">
                <div className="pb-12 text-center">
                    <h2 className="text-base font-semibold leading-7 text-gray-900">Reservar cancha</h2>
                    <p className="mt-1 text-sm leading-6 text-gray-600">Completa los datos de la cancha</p>

                    <div className="mt-2. grid grid-cols-1 gap-x-10 gap-y-8 sm:grid-cols-2 w-3/5 m-auto">
